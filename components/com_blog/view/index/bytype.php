...
<html lang="vi">
    <head>
        ...
        <!-- Title-->
        <title><?php echo $typeName; ?> | Công Ty Cổ Phần Tâm Cầu</title>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="col-12 text-center mt-5">
                            <div class="alert border border-success text-success bg-success-0_1 px-4 py-3 alert-dismissible fade show" role="alert">
                                ...
                                <p>
                                    Chưa có bài viết nào trong <span class="font-weight-bold"><?php echo $typeName; ?></span>. Vui lòng quay lại sau nhé!
                                </p>
                            </div>
                        </div>
                    <?php } ?>
